                                        ...
                                        <td>
                                                ...
                                                {{--@if($employee->image==null)--}}
                                                   ...
                                                   <span style="margin-left: 100px;float: right;margin-top: 40px;margin-right: 400px">
                                                        <form action="{{route('update.image',$employee->id)}}" method="post" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                    ...
                                                    <img src="{{ asset('employee/'.$employee->image) }}" width="100px" height="100px" alt="{{ asset('img/no.png') }}">
