...
<div class="clearfix main-wrapper">
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-9">
                                                        {!! Form::text('managed_medicaid_health_plan',$client->profile ? $client->profile->managed_medicaid_health_plan:'',['id'=>'managed_medicaid_health_plan','class' => 'form-control','required'=> 'required','Placeholder'=>'Enter Medicaid health plan you are in now']) !!}
                                        ...
                                        <div class="col-xs-12 col-sm-12">
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-9">
                                                        {!! Form::text('managed_MLTC_plan',$client->profile ? $client->profile->managed_MLTC_plan:'',['id'=>'managed_MLTC_plan','class' => 'form-control','required'=> 'required','Placeholder'=>'Enter MLTC plan you are transferring to']) !!}
                                        ...
                                        <div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="col-xs-12 col-sm-3">
                                                    <div class="form-group">
                                                        <div class="col-xs-12">
                                                            {!! Form::label('medicaid_id', 'Medicaid ID') !!}<span
                                                                    class="required"> * </span>
                                                            {!! Form::text('medicaid_id',Input::old('medicaid_id'),['id'=>'medicaid_id','class' => 'form-control','required'=> 'required','Placeholder'=>'Enter Medicaid ID']) !!}
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-xs-12">
                                                                    {!! Form::label('country', 'Country') !!}<span
                                                                            class="required"> * </span>
                                                                    {!! Form::Select('country',array('usa'=>'USA','canada'=>'Canada'),$client->profile ? $client->profile->country:'',['id'=>'country', 'class'=>'form-control ']) !!}
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <div class="col-xs-12">
                                                                    {!! Form::label('state', 'State') !!}<span
                                                                            class="required"> * </span>
                                                                    {!! Form::Select('state',array('michigan'=>'Michigan'),$client->profile ? $client->profile->state:'',['id'=>'state', 'class'=>'form-control ']) !!}
                                                                </div>
                                                            </div>
                                                            @if ($errors->has('state'))
                                                                <div class="error"
    ...
    padding: 6px">
                                <h3 style="color: white">Authorized Representative</h3>
                            </div>
                            <div class="form-horizontal" role="form">
                                <fieldset>
                                    <div>
                                        <div class="row-fluid">
                                            <div class="col-xs-12 col-sm-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-xs-12">
                                                        {!! Form::text('authorized_first_name',$client->profile ? $client->profile->authorized_first_name:'',['id'=>'authorized_first_name','class' => 'form-control','style'=>'height:50px;','Placeholder'=>'Enter First Name']) !!}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6">
                                                        ...
                                                        @if ($errors->has('relationship_to_member'))
                                                            <div class="error"
                                                                 style="color: red">{{ $errors->first('relationship_to_member') }}</div>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12">
                                                                {!! Form::Select('authorized_address',array('usa'=>'USA','canada'=>'Canada'),$client->profile ? $client->profile->authorized__address:'',['id'=>'authorized_address', 'class'=>'form-control ']) !!}
                                                            </div>
                                                        </div>
                                                        @if ($errors->has('authorized_address'))
                                                            <div class="error"
                                                                 style="color: red">{{ $errors->first('authorized_address') }}</div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        ...
                                                        @if ($errors->has('authorized_city'))
                                                            <div class="error"
                                                                 style="color: red">{{ $errors->first('authorized_city') }}</div>
                                                        @endif
                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12">
                                                                {!! Form::Select('authorized_country',array('michigan'=>'Michigan'),$client->profile ? $client->profile->authorized_country:'',['id'=>'authorized_country', 'class'=>'form-control ']) !!}
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-xs-12">
                                                                {!! Form::Select('authorized_state',array('michigan'=>'Michigan'),$client->profile ? $client->profile->authorized_state:'',['id'=>'authorized_state', 'class'=>'form-control ']) !!}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div id="ht-inquiry-location-container" style="margin-left: 15px">
                            ...
                            <div class="checkbox">
                                <label for="Value1" title="">
                                    ...
                                    gfsgbb That I must join a Managed Long Term Care Plan (MLTC Plan) to receive Medicaid
                                    community-based
                                    long term care (cbltc) services in my county.
    ...
    padding: 6px">
                                <h3>
                    <span style="color: white">4a. Please add check mark <span class="glyphicon glyphicon-ok-circle"
                                                                               aria-hidden="true"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12">
                                                        <div class="checkbox" style="width: 100%;">
                                                            <label for="Value10" title="">
                                                                ...
                                                                <span>Environmental Modification: Internal and external physical adaptations to the home, which are
                                ...
                                <fieldset>
                                    <div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="col-xs-12 col-sm-12">
                                                <div class="title_bar">
                                                    <h2>SECTION 5. Managed Long Term Care Plan (MLTC Plan)</h2>
                                                </div>
